...
tgid="1406503658"  # ID чата для автобэкапа (Необходим доступ к сообщениям)
tg2id="1406503658" # ID чата диллерской группы для отправки ключей
admls="1406503658"	   # ID Админа
bot_api="8057517512:AAFg-I1IEE8EyMst_saT79BcZ8M2AKSS6ZA" # Токен бота 
